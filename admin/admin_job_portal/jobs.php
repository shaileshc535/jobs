  ...
  <div class="dashboard-ecommerce">
    ...
    <?php
        if(isset($_POST['submit'])){
          ...
          $wca = $_POST['wca'];
          //  $query = mysqli_query($con,"INSERT INTO `job_post`(`company`, `jobtitle`, `email`, `description`,  `perks`, `jobtype`, `stipend`, `salary`, `experience`, `openings`, `qualification`, `createdat`, `image`, `verify`, `jobheading`, `state`, `city`) VALUES ('$cname', '$j_title', '$email', '$desc','$perks','$j_type', '$stipend', '$salary', '$exp', '$openings', '$wca', current_timestamp(), '$file_name', '$verified', '$j_category','$stateId','$cityId')");                   
