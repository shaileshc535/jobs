                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown"
                                ...
                                <a class="dropdown-item" href="http://materiallibrary.co.in/admin/signout.php"><i
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-1" class="collapse submenu">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="http://materiallibrary.co.in/admin/admin_job_portal/index.php">Job
                                                Portal</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="http://materiallibrary.co.in/admin/admin_video_library/index.php">Video Library</a>
                                        </li>
                                        <li class=" nav-item">
                                            <a class="nav-link" href="http://materiallibrary.co.in/admin/admin_behance/index.php">Portfolio
                                                Management</a>
                                        </li>
                                    </ul>
                                </div>
