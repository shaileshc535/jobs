                        ...
                        <div class="card-body">
                            ...
                            if (isset($_GET['id'])) {
                                ...
                                if ($count == 1) {
                                    ...
                                    header('location:http://materiallibrary.co.in/admin/admin_job_portal//manage_category.php');
                                }
                            }
                            ?>
        ...
        if (isset($_POST['submit'])) {
            ...
            if (mysqli_num_rows($check) > 0) {
                ...
                if ($res2 == TRUE) {
                    ...
                    // redirect page to manage admin
                    header("location:http://materiallibrary.co.in/admin/admin_job_portal/n/update_job_categories.php');
                }
            }
        }
        ?>
