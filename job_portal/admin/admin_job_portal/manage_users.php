                ...
                <?php 
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
								if($row['active']==1){
									echo "<span class='badge badge-complete'><a href='?type=status&operation=active&id=".$row['id']."'>Unblock</a></span>&nbsp;";
								}else{
									echo "<span class='badge badge-pending'><a href='?type=status&operation=dactive&id=".$row['id']."'>Block</a></span>&nbsp;";
								            }
