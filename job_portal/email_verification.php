...
<div class="careerfy-subheader careerfy-subheader-without-bg">
      ...
      <div class="careerfy-breadcrumb">
            <ul>
                  ...
                  <li><a href="http://materiallibrary.co.in/employer-dashboard-applied-candidate">Pages</a></li>
                  <li>Candidates</li>
            </ul>
      </div>
</div>
            ...
            <div class="container">
                  <div class="row">
                        ...
                        Profile</a></li> -->
                                                ...
                                                <li><a href="http://materiallibrary.co.in/employer-manage-jobs.php"><i
                                                ...
                                                <li><a href="employer-dashboard-resumes.php?id=<?php echo $jid; ?>"><i
                                                            ...
                                                            Resumes</a></li>
                                                <li><a href="employer-dashboard-hired.php?id=<?php echo $jid; ?>"><i
                                                                  class="careerfy-icon careerfy-heart"></i> Hired
                                                            Candidates</a></li>

                                                <!-- <li><a href="http://materiallibrary.co.in/employer-dashboard-newjob"><i class="careerfy-icon careerfy-add"></i>
                        Post a New Job</a></li> -->
                                                <!-- <li><a href="http://materiallibrary.co.in/employer-dashboard-confirmation" ><i class="far fa-star-half"></i>
                        Job Status</a></li> -->

                                                <!-- <li><a href="http://materiallibrary.co.in/employer-dashboard-changed-password.php?id=<?php echo $id; ?>"><i
                        ...
                        <div class="careerfy-column-9">
                              <div class="careerfy-typo-wrap">
                                    <div class="careerfy-employer-dasboard">
                                          <div class="careerfy-employer-box-section" id="ml-appliedsachin">
                                                <!-- Profile Title -->
