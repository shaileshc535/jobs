...
if (isset($_SESSION['loggedin'])) {
      ...
      if (isset($_POST['apply'])) {
            if (mysqli_num_rows($get_edu) > 0 && mysqli_num_rows($get_skill) > 0) {
                  $job_id = $_GET['id'];
                  $cid = $_GET['cid'];
        ...
        ALLREADY APPLIED!
                        ...
                        header('location:http://materiallibrary.co.in/candidate-dashboard-applied-jobs');
                  }
            } else {
                        ...
                        <div class="row">
                              ...
                              <div class="careerfy-column-9">
                                    <div class="careerfy-typo-wrap">
                                          ...
                                          <div class="careerfy-employer-box-section" id="ml-sachin">
                                          ...
                                          <form method="POST">
                                                <input type="submit" name="apply"
                                                      class="careerfy-employer-profile-submit" value="Apply">
                                          </form>
                                    </div>
                              </div>
