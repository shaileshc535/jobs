<?php
ob_start();
require '../admin/assets/_dbconnect.php';
                                    ...
                                    <li class="has-dropdown" data-tooltip="tooltip" data-placement="left"
                                        ...
                                        <ul style="width:120px">
                                            <li>
                                                ...
                                                <a href="candidate-dashboard-profile-seting"><i
                    ...
                    <div class="secondary-nav" style="margin-bottom: 40px;">
                        ...
                        <div class="menu-init" id="navigation1" style="margin-left:50px;">
                            ...
                            <div class="ah-lg-mode">
                                ...
                                <a href="index-six.html">JOBS</a></li>
                                            ...
                                            <li class="has-dropdown" style="color:black">
                                                ...
                                                <ul style="width:170px">
                                                    <li class="has-dropdown has-dropdown--ul-left-100">
                                                        ...
                                                        <a href="job-listings">Job Listing<i
                                                                class="fas fa-angle-down i-state-right u-s-m-l-6"></i></a>
                                                        <a href="employer-list?p=1">Employer<i
                                                                class="fas fa-angle-down i-state-right u-s-m-l-6"></i></a>
                                                        <a href="candidate-listings">Candidates<i
                                                                class="fas fa-angle-down i-state-right u-s-m-l-6"></i></a>
